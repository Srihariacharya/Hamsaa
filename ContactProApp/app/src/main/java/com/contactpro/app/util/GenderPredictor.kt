...
object GenderPredictor {
    ...
    fun predict(name: String): String {
        ...
        // Comprehensive Indian + Global male first names
        val maleNames = setOf(
            // Indian male names (including those ending in 'a' that are commonly mistaken)
        ...
        // Comprehensive Indian + Global female first names
        ...
        // If not in the curated list, DO NOT guess — return safe fallback
